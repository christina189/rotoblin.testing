...
#define SMEXT_CONF_DESCRIPTION	"Downtown1's extension to call do useful L4D calls"
#define SMEXT_CONF_VERSION		"0.3.1.0"
#define SMEXT_CONF_AUTHOR		"Igor \"Downtown1\" Smirnov"
